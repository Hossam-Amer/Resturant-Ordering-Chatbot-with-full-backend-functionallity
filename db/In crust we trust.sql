CREATE DATABASE  IF NOT EXISTS `In crust we trust` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `In crust we trust`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: In crust we trust
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'In crust we trust'
--
